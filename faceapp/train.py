...
message = tk.Label(window, text="Face Recognization" ,bg="Black"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold')) 
...
message = tk.Label(window, text="" ,bg="White"  ,fg="red"  ,width=30  ,height=2, activebackground = "Black" ,font=('times', 15, ' bold ')) 
message.place(x=700, y=400)




message2 = tk.Label(window, text="" ,fg="red"   ,bg="White",activeforeground = "Black",width=30  ,height=2  ,font=('times', 15, ' bold ')) 
...
def email_send():
    ...
    toaddr = 'manoharmanu6634@gmail.com'
    msg = MIMEMultipart()
    ...
    attachment = open("unknown.jpg", "rb")
...
takeImg = tk.Button(window, text="Take Images", command=TakeImages  ,fg="White"  ,bg="Black"  ,width=20  ,height=3, activebackground = "White" ,font=('times', 15, ' bold '))
takeImg.place(x=200, y=500)
trainImg = tk.Button(window, text="Train Images", command=TrainImages  ,fg="White"  ,bg="Black"  ,width=20  ,height=3, activebackground = "White" ,font=('times', 15, ' bold '))
trainImg.place(x=500, y=500)
trackImg = tk.Button(window, text="Track Images", command=TrackImages  ,fg="White"  ,bg="Black"  ,width=20  ,height=3, activebackground = "White" ,font=('times', 15, ' bold '))
